...
public class StartGame extends Application implements Constants {
  ...
  public static void writePosInFile(double heroPosX, double heroPosY) {
  ...
  // save shoot in file
  public static void writeShootInFile() {
    try (FileWriter writer = new FileWriter("save.txt", true)) {
  ...
  // save bots in file
  public static void writeBotsInFile(int botPosX, int botPosY) {
    try (FileWriter writer = new FileWriter("save.txt", true)) {
  ...
  // load game and watch
  public void replay(Text score, Text health, Scene scene, Pane root) {
  ...
  public void computerGame(Text score, Text health, Scene scene, Pane root) {
    // update score and health on screen
    score.setText("Score: " + player.getScore());
    health.setText("Health: " + player.getHealth());
  ...
  public void start(Stage primaryStage, Levels type, Maps map, Games game) {
    ...
    //replay(score, health, scene, root);
    ...
    AnimationTimer timer = new AnimationTimer() {
      ...
      public void handle(long now) {
        ...
        if (game == Games.STANDARD) {
          ...
          computerGame(score, health, scene, root);
          createBots(root);
